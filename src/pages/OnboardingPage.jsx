...
const slides = [
  {
    ...
    image: '/assets/images/common/slide1.png',
  },
  {
    text: '글로벌 이슈와 함께 다양한 공모전이 당신의 도전을 기다리고 있습니다.',
    image: '/assets/images/common/slide2.png',
  },
  {
    text: '관심사에 꼭 맞는 추천으로, 더 특별한 기회를 만나보세요.',
    image: '/assets/images/common/slide3.png',
  },
  {
    text: '지금, 당신의 아이디어를 마음껏 펼쳐보세요!',
    image: '/assets/images/common/slide4.png',
  },
];
    ...
    <Wrapper>
      <Container>
        ...
        <RightSection>
          ...
          <GoogleButton>
            <GoogleIcon src="/assets/images/common/ic_google.png" alt="google_icon" />
            <span>구글로 시작하기</span>
          </GoogleButton>
        </RightSection>
      </Container>
